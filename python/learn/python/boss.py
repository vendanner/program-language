    ...
    try:
        while True:
            ...
            try:
                ...
                # 职位名
                item['position'] = html_obj.xpath(".//div[@class='job-banner']//h1/text()")[0]
                # 发布者姓名
...
def write_data(page):
    ...
    :return: None
    """
    with open('offer/jobs/wuhan_python_job_{}.json'.format(page), 'w', encoding='utf-8') as f:
        f.write('[')
        try:
            while True:
