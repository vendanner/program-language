...
import com.danner.java.sql.base.out.SqlBaseBaseVisitor;
import com.danner.java.sql.base.out.SqlBaseParser;

/*
* 本例中是先序遍历，
* Spark SQL 中的 AstBuilder 是后序遍历(先生成子节点逻辑计划，再生成当前节点)
* 后续进行改进成 AstBuilder 类似
* */
public class MyVisitor extends SqlBaseBaseVisitor<String> {
    ...
    public String visitCreateTableUsing(SqlBaseParser.CreateTableContext ctx) {
    ...
    public String visitBooleanDefault(SqlBaseParser.BooleanValueContext ctx) {
